          ...
          <form className="flex flex-col gap-5" onSubmit={onSubmit}>
            ...
            <div className="flex flex-col md:flex-row gap-5">
                      <label className="text-gray-800 text-sm font-bold flex-1">
                         First Name
                         <input className="border w-full rounded px-2 py-1 font-normal" {...register("firstName", { required: "This field is required" })} />
                         {errors.firstName && (<span className="text-red-500"> {errors.firstName.message} </span>)}
                      </label>

                      <label className="text-gray-800 text-sm font-bold flex-1">
                         Last Name
                         <input className="border w-full rounded px-2 py-1 font-normal"  {...register("lastName", { required: "This field is required" })} />
            ...
            <label className="text-gray-800 text-sm font-bold flex-1">
                         Confirm Password
                         <input type="password" className="border w-full rounded px-2 py-1 font-normal"  {...register("confirmPassword", { 
                            validate:(val) => {
                                if (!val) {
